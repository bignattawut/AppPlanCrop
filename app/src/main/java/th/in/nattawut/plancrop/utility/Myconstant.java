...
public class Myconstant {
    ...
    //ล็อคอิน
    private String urlGetUser = "http://192.168.1.133/android/php/getAll.php";

    //วางแผนเพาะปลูก
    private String urladdPlan = "http://192.168.1.133/android/php/insertplan.php";
    public static String getUrlCrop ="http://192.168.1.133/android/php/selectspinnercrop.php";
    public static String getUrlmid = "http://192.168.1.133/android/php/selectmidspinner.php";
    private String[] columnPlanString = new String[]{"No", "MID", "PDate", "CID", "Area"};
    private String urlGetPlan = "http://192.168.1.133/android/php/getPlanView.php";
    private String urlselectPlan = "http://192.168.1.133/android/php/selectplan.php";

    //เกษตรกร
    private String urlRegister = "http://192.168.1.133/android/php/addregister.php";
    private  String urlGetRegister = "http://192.168.1.133/android/php/getregister.php";
    ...
    public static String getUrlProvince = "http://192.168.1.133/android/php/selectprovince.php";
    public static String getUrlAmphur = "http://192.168.1.133/android/php/selectdistrict.php";

    //พืช
    private String urlAddCrop = "http://192.168.1.133/android/php/insertcrop.php";
    ...
    private String urlselectCrop = "http://192.168.1.133/android/php/a.php";
    private String[] columnCropString = new String[]{"cid","crop","tid","beginharvest","harvestperiod","yield"};

    //ประเภทพืช
    public static String getUrlCropType = "http://192.168.1.133/android/php/selectcroptype.php";
    private String urlAddCropType = "http://192.168.1.133/android/php/insertcroptype.php";
    private String urlselectcroptype = "http://192.168.1.133/android/php/selectcroptype.php";
    private String urlEditCropType = "http://192.168.1.133/android/php/editcroptype.php";
    private String urlDeleteCropType = "http://192.168.1.133/android/php/deletecroptype.php";
    private String[] columnCropTypeString = new String[]{"TID","croptype"};

    //กิจกรรม
    private String urlAddPlantPicture = " http://192.168.1.133/android/php/insertactivity.php";

    //ทดสอบ
    private String urlplantpicture = "http://192.168.1.130/android/php/addPlantPicture.php";
